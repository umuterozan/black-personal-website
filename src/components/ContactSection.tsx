...
export default function ContactSection() {
    return (
        <section>
            <div className="container flex items-center gap-x-5 pt-[65px] pb-[45px] pl-6 pr-[316px]">
                <Image
                    src="/Saly-14.svg"
                    alt="Saly-14"
                    width={263}
                ...
                <div className="text-white">
                    ...
                    <div className="mt-[35px] font-semibold text-base leading-[19px]">
                        <p>
                        ...
                        <div className="mt-11 font-semibold flex items-center gap-x-[11px]">
                            <ButtonGroup />
                        </div>
                    </div>
                </div>
